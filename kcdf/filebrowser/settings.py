...
try:
    ...
    DEFAULT_PATH_TINYMCE = tinymce.settings.JS_ROOT + '/tiny_mce/'
except ImportError:
    DEFAULT_URL_TINYMCE = settings.ADMIN_MEDIA_PREFIX + "tinymce/jscripts/tiny_mce/"
    DEFAULT_PATH_TINYMCE = os.path.join(settings.MEDIA_ROOT, 'js/tiny_mce/')
...
URL_FILEBROWSER_MEDIA = getattr(settings, "FILEBROWSER_URL_FILEBROWSER_MEDIA", "/site_media/filebrowser/")
