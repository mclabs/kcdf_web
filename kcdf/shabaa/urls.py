...
urlpatterns+=patterns('shabaa.views',
		...
		(r'^funder/(?P<slug>[^\.^/]+)/$', 'funders_detail',{},'resource-center'),
		(r'^legal-document/(?P<slug>[^\.^/]+)/$', 'legal_detail',{},'resource-center'),
		...
		(r'^service-provider/(?P<slug>[^\.^/]+)/$', 'service_detail',{},'resource-center'),
